...
const productSchema = z.object({
  ...
  price: z.number().min(1, { message: "The Price has to be bigger then 0" }),
  smallDescription: z
    .string()
    .min(10, { message: "Please summarize your product more" }),
  description: z.string().min(10, { message: "Description is require" }),
  images: z.array(z.string(), { message: "Images are require" }),
  productFile: z
    .string()
...
const userSettingsSchema = z.object({
  firstName: z
    .string()
    .min(3, { message: "Minimum length of 3 require" })
    .or(z.literal(""))
    .optional(),
...
export async function SellProduct(prevState: any, formData: FormData) {
  ...
  if (!validateFields.success) {
    const state: State = {
      ...
      message: "Oops, I think there is mistake with your inputs.",
    };
